import{t as e}from"./three.module-DRRYkRPO.js";var t=`
#ifdef USE_FOG
  ...
  #endif
#endif
`;function n(){e.fog_pars_fragment=`
#ifdef USE_FOG
  ...
  #endif
#endif
`,e.fog_fragment=t,e.fog_pars_vertex=`
#ifdef USE_FOG
  varying float vFogDepth;
  #ifdef USE_FOG_WORLD_POSITION
    varying vec3 vFogWorldPosition;
...
`,e.fog_vertex=`
  ...
  #endif
#endif
`}function r(e,t){e.uniforms.fogVolumeData=t.fogVolumeData,e.uniforms.cameraHeight=t.cameraHeight,e.uniforms.fogEnabled=t.fogEnabled}function i(e,n){r(e,n),e.vertexShader=e.vertexShader.replace(`#include <fog_pars_vertex>`,`#include <fog_pars_vertex>
#ifdef USE_FOG
  ...
  #define USE_FOG_WORLD_POSITION
  varying vec3 vFogWorldPosition;
#endif`),e.fragmentShader=e.fragmentShader.replace(`#include <fog_fragment>`,t)}var a=3,o=4,s={fogVolumeData:{value:new Float32Array(a*o)},cameraHeight:{value:0},fogEnabled:{value:!0}};function c(e,t,n=!0){s.cameraHeight.value=e,s.fogVolumeData.value.set(t),s.fogEnabled.value=n}function l(){s.cameraHeight.value=0,s.fogVolumeData.value.fill(0),s.fogEnabled.value=!0}function u(e){let t=new Float32Array(a*o);for(let n=0;n<a;n++){let r=n*o,i=e[n];i&&(t[r+0]=i.visibleDistance,t[r+1]=i.minHeight,t[r+2]=i.maxHeight,t[r+3]=i.percentage)}return t}export{t as a,c as i,u as n,i as o,l as r,n as s,s as t};