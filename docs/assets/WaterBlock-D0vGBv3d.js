import{r as e}from"./chunk-DECur_0Z.js";import{n as t,r as n,t as r}from"./jsx-runtime-BpGWiA-R.js";import{c as i,n as a,o}from"./Html-DrHEhPVE.js";import{a as s,i as c}from"./SettingsProvider-DVIFsPwe.js";import{p as l}from"./loaders-BhaVxgpz.js";import{At as u,Dt as d,b as f,gt as ee,nt as p}from"./three.module-DRRYkRPO.js";import{t as m}from"./Texture-D7437V2F.js";import{n as te,r as ne,t as re}from"./scene-6ZXksKVQ.js";import{a as h,t as g}from"./globalFogUniforms-CCW7odYy.js";import{a as _,t as v}from"./useAnisotropy-nhH7jNtm.js";var y=e(n());function b(e,t){let n=e+`Geometry`;return y.forwardRef(({args:e,children:r,...i},o)=>{let s=y.useRef(null);return y.useImperativeHandle(o,()=>s.current),y.useLayoutEffect(()=>void t?.(s.current)),y.createElement(`mesh`,a({ref:s},i),y.createElement(n,{attach:`geometry`,args:e}),r)})}var x=b(`box`),S=t(),C=`
...
`;function ie(e){return new u({uniforms:{uTime:{value:0},uOpacity:{value:e?.opacity??.75},uWaveMagnitude:{value:e?.waveMagnitude??1},uEnvMapIntensity:{value:e?.envMapIntensity??1},uBaseTexture:{value:e?.baseTexture??null},uEnvMapTexture:{value:e?.envMapTexture??null},fogColor:{value:new f},fogNear:{value:1},fogFar:{value:2e3},fogVolumeData:g.fogVolumeData,cameraHeight:g.cameraHeight,fogEnabled:g.fogEnabled},vertexShader:C,fragmentShader:w,transparent:!0,side:2,depthWrite:!0,fog:!0})}function ae(){let e=(0,S.c)(1),t=(0,y.useRef)(null),n;return e[0]===Symbol.for(`react.memo_cache_sentinel`)?(n=e=>{if(!t.current)return t.current=e.clone(),!0;let n=t.current.x===e.x&&t.current.y===e.y&&t.current.z===e.z;return n||t.current.copy(e),n},e[0]=n):n=e[0],n}var T=r(),E=2048,D=1024;function oe(e,t){let n=e<=1024&&t<=1024?8:16;return[Math.max(4,Math.ceil(e/n)),Math.max(4,Math.ceil(t/n))]}function O(e){let t=(0,S.c)(7),{surfaceTexture:n,attach:r}=e,i;t[0]===n?i=t[1]:(i=l(n),t[0]=n,t[1]=i);let a=i,o=v(),s;t[2]===o?s=t[3]:(s=e=>_(e,{anisotropy:o}),t[2]=o,t[3]=s);let c=m(a,s),u;return t[4]!==r||t[5]!==c?(u=(0,T.jsx)(`meshStandardMaterial`,{attach:r,map:c,transparent:!0,opacity:.8,side:2}),t[4]=r,t[5]=c,t[6]=u):u=t[6],u}var k=(0,y.memo)(function(e){let t=(0,S.c)(59),{entity:n}=e,r=n.waterData,{debugMode:a}=c(),s;t[0]===r.transform?s=t[1]:(s=re(r.transform),t[0]=r.transform,t[1]=s);let l=s,u;t[2]===r.transform.position?u=t[3]:(u=ne(r.transform.position),t[2]=r.transform.position,t[3]=u);let d=u,f;t[4]===r.scale?f=t[5]:(f=te(r.scale),t[4]=r.scale,t[5]=f);let p=f,[m,h,g]=p,_=i(ce),v=ae(),b=r.waveMagnitude,[C,w,ie]=d,O=C+D,k=ie+D,A;t[6]===O?A=t[7]:(A=Math.round(O/8),t[6]=O,t[7]=A);let j=A,M;t[8]===k?M=t[9]:(M=Math.round(k/8),t[8]=k,t[9]=M);let N=M;j=Math.max(0,Math.min(2040,j)),N=Math.max(0,Math.min(2040,N));let P=j*8,F=N*8,I;t[10]!==P||t[11]!==F||t[12]!==w?(I=[P,w,F],t[10]=P,t[11]=F,t[12]=w,t[13]=I):I=t[13];let L=I,ue=le,R;t[14]!==_.position.x||t[15]!==_.position.z?(R=()=>ue(_.position.x,_.position.z),t[14]=_.position.x,t[15]=_.position.z,t[16]=R):R=t[16];let[z,de]=(0,y.useState)(R),B;t[17]!==_.position||t[18]!==v?(B=()=>{if(!v(_.position))return;let e=ue(_.position.x,_.position.z);de(t=>t.length===e.length&&t.every((t,n)=>t[0]===e[n][0]&&t[1]===e[n][1])?t:e)},t[17]=_.position,t[18]=v,t[19]=B):B=t[19],o(B);let V=r.surfaceName||`liquidTiles/BlueWater`,H=r.envMapName||void 0,U=r.surfaceOpacity,W=r.envMapIntensity,G;if(t[20]!==m||t[21]!==h||t[22]!==g){let[e,n]=oe(m,g);G=new ee(m,g,e,n),G.rotateX(-Math.PI/2),G.translate(m/2,h,g/2),t[20]=m,t[21]=h,t[22]=g,t[23]=G}else G=t[23];let K=G,q,J;t[24]===K?(q=t[25],J=t[26]):(J=()=>()=>{K.dispose()},q=[K],t[24]=K,t[25]=q,t[26]=J),(0,y.useEffect)(J,q);let Y;t[27]!==a||t[28]!==d[0]||t[29]!==d[1]||t[30]!==d[2]||t[31]!==p||t[32]!==m||t[33]!==h||t[34]!==g?(Y=a&&(0,T.jsx)(x,{args:p,position:[d[0]+m/2,d[1]+h/2,d[2]+g/2],children:(0,T.jsx)(`meshBasicMaterial`,{color:`#00fbff`,wireframe:!0})}),t[27]=a,t[28]=d[0],t[29]=d[1],t[30]=d[2],t[31]=p,t[32]=m,t[33]=h,t[34]=g,t[35]=Y):Y=t[35];let X;if(t[36]!==L||t[37]!==z||t[38]!==K){let e;t[40]!==L||t[41]!==K?(e=e=>{let[t,n]=e,r=L[0]+t*E-D,i=L[2]+n*E-D;return(0,T.jsx)(`mesh`,{geometry:K,position:[r,L[1],i],children:(0,T.jsx)(`meshStandardMaterial`,{color:`#00fbff`,transparent:!0,opacity:.4,wireframe:!0,side:2})},`${t},${n}`)},t[40]=L,t[41]=K,t[42]=e):e=t[42],X=z.map(e),t[36]=L,t[37]=z,t[38]=K,t[39]=X}else X=t[39];let Z;t[43]!==L||t[44]!==W||t[45]!==H||t[46]!==U||t[47]!==z||t[48]!==K||t[49]!==V||t[50]!==b?(Z=(0,T.jsx)(se,{reps:z,basePosition:L,surfaceGeometry:K,surfaceTexture:V,envMapTexture:H,opacity:U,waveMagnitude:b,envMapIntensity:W}),t[43]=L,t[44]=W,t[45]=H,t[46]=U,t[47]=z,t[48]=K,t[49]=V,t[50]=b,t[51]=Z):Z=t[51];let Q;t[52]!==X||t[53]!==Z?(Q=(0,T.jsx)(y.Suspense,{fallback:X,children:Z}),t[52]=X,t[53]=Z,t[54]=Q):Q=t[54];let $;return t[55]!==l||t[56]!==Y||t[57]!==Q?($=(0,T.jsxs)(`group`,{quaternion:l,children:[Y,Q]}),t[55]=l,t[56]=Y,t[57]=Q,t[58]=$):$=t[58],$}),se=(0,y.memo)(function({reps:e,basePosition:t,surfaceGeometry:n,surfaceTexture:r,envMapTexture:i,opacity:a,waveMagnitude:c,envMapIntensity:u}){let f=l(r),ee=l(i??`special/lush_env`),te=v(),[ne,re]=m([f,ee],e=>{(Array.isArray(e)?e:[e]).forEach(e=>{_(e,{anisotropy:te}),e.colorSpace=``,e.wrapS=d,e.wrapT=d})}),{animationEnabled:h}=s(),g=(0,y.useMemo)(()=>ie({opacity:a,waveMagnitude:c,envMapIntensity:u,baseTexture:ne,envMapTexture:re}),[a,c,u,ne,re]),b=(0,y.useRef)(0),x=(0,y.useRef)(null),S=(0,y.useRef)(new p),C=(0,y.useRef)(null),w=(0,y.useRef)(null);return o((n,r)=>{h?(b.current+=r,g.uniforms.uTime.value=b.current):(b.current=0,g.uniforms.uTime.value=0);let i=x.current;if(!i||i===C.current&&e===w.current)return;C.current=i,w.current=e;let a=S.current;for(let n=0;n<e.length;n++){let[r,o]=e[n],s=t[0]+r*E-D,c=t[2]+o*E-D;a.makeTranslation(s,t[1],c),i.setMatrixAt(n,a)}i.count=e.length,i.instanceMatrix.needsUpdate=!0}),(0,y.useEffect)(()=>()=>{g.dispose()},[g]),(0,T.jsx)(`instancedMesh`,{ref:x,args:[n,g,9],frustumCulled:!1,renderOrder:-1})});function ce(e){return e.camera}function le(e,t){let n=e+D,r=t+D,i=Math.trunc(n/E),a=Math.trunc(r/E);n<0&&i--,r<0&&a--;let o=[];for(let e=a-1;e<=a+1;e++)for(let t=i-1;t<=i+1;t++)o.push([t,e]);return o}export{k as WaterBlock,O as WaterMaterial};