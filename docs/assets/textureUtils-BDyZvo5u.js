import{v as e}from"./events-156d8d12.esm-u8ZdQWGw.js";import{Ba as t,Gi as n,Jr as r,Ln as i,Nn as a,Ri as o,Xt as s,ut as c,wa as l}from"./three.core-D2MYdXnG.js";var u=`
#ifdef USE_FOG
  ...
  #endif
#endif
`;function d(){e.fog_pars_fragment=`
#ifdef USE_FOG
...
#endif
`,e.fog_fragment=u,e.fog_pars_vertex=`
#ifdef USE_FOG
  varying float vFogDepth;
  #ifdef USE_FOG_WORLD_POSITION
    varying vec3 vFogWorldPosition;
...
#include <fog_pars_fragment>
  ...
  #define USE_FOG_WORLD_POSITION
  varying vec3 vFogWorldPosition;
#endif`),e.fragmentShader=e.fragmentShader.replace(`#include <fog_fragment>`,u)}var m=3,h=4,g={fogVolumeData:{value:new Float32Array(12)},cameraHeight:{value:0},fogEnabled:{value:!0},fogDistanceScale:{value:1}};function _(e,t,n=!0){g.cameraHeight.value=e,g.fogVolumeData.value.set(t),g.fogEnabled.value=n}function v(){g.cameraHeight.value=0,g.fogVolumeData.value.fill(0),g.fogEnabled.value=!0,g.fogDistanceScale.value=1}function y(e){let t=new Float32Array(12);for(let n=0;n<m;n++){let r=n*h,i=e[n];i&&(t[r+0]=i.visibleDistance,t[r+1]=i.minHeight,t[r+2]=i.maxHeight,t[r+3]=i.percentage)}return t}var b=new s;b.setOptions({premultiplyAlpha:`none`});var x=new Map;function S(e,t,n){let r=x.get(e);if(r)return t&&r.image&&t(r),r;let i=new l;return i.flipY=!1,x.set(e,i),b.load(e,e=>{i.image=e,i.needsUpdate=!0,t?.(i)},void 0,()=>{x.delete(e),n?.(e)}),i}function C(e){let t=x.get(e);return t?t.image?Promise.resolve(t):new Promise(e=>{let n=()=>{t.image?e(t):setTimeout(n,16)};n()}):new Promise((t,n)=>{let r=new l;r.flipY=!1,x.set(e,r),b.load(e,e=>{r.image=e,r.needsUpdate=!0,t(r)},void 0,n)})}function w(e,t={}){let{repeat:r=[1,1],disableMipmaps:s=!1,anisotropy:c,noColorSpace:l=!1}=t;return e.wrapS=e.wrapT=o,l||(e.colorSpace=n),e.repeat.set(...r),e.flipY=!1,e.anisotropy=c??1,s?(e.generateMipmaps=!1,e.minFilter=a):(e.generateMipmaps=!0,e.minFilter=i),e.magFilter=a,e.image&&(e.needsUpdate=!0),e}function T(e,n=256){let i=[];for(let s=0;s<e.length;s+=3){let l=e[s],u=e[s+1],d=e[s+2],f=n*n,p=new Uint8Array(f*4);for(let e=0;e<f;e++)p[e*4]=l[e],p[e*4+1]=u?u[e]:0,p[e*4+2]=d?d[e]:0,p[e*4+3]=255;let m=new c(p,n,n,r,t);m.colorSpace=``,m.wrapS=m.wrapT=o,m.generateMipmaps=!1,m.minFilter=a,m.magFilter=a,m.needsUpdate=!0,i.push(m)}return i}export{g as a,_ as c,d,w as i,u as l,C as n,y as o,T as r,v as s,S as t,p as u};