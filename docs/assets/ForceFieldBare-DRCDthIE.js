...
`;function b({textures:e,scale:t,umapping:n,vmapping:r,color:i,baseTranslucency:a}){let o=[...t].sort((e,t)=>t-e),u=new c(o[0]*n,o[1]*r),d=e[0];return new l({uniforms:{frame0:{value:d},frame1:{value:e[1]??d},frame2:{value:e[2]??d},frame3:{value:e[3]??d},frame4:{value:e[4]??d},currentFrame:{value:0},vScroll:{value:0},uvScale:{value:u},tintColor:{value:new s(...i)},opacity:{value:a},opacityFactor:{value:1},fogColor:{value:new s},fogNear:{value:1},fogFar:{value:2e3}},vertexShader:v,fragmentShader:y,transparent:!0,blending:2,side:2,depthWrite:!1,fog:!0})}var x=r();function S(e){e.wrapS=e.wrapT=u,e.colorSpace=``,e.flipY=!1,e.needsUpdate=!0}function C(e){let t=(0,_.c)(7),[n,r,i]=e,a;t[0]!==n||t[1]!==r||t[2]!==i?(a=new o(n,r,i),a.translate(n/2,r/2,i/2),t[0]=n,t[1]=r,t[2]=i,t[3]=a):a=t[3];let s=a,c,l;return t[4]===s?(c=t[5],l=t[6]):(c=()=>()=>s.dispose(),l=[s],t[4]=s,t[5]=c,t[6]=l),(0,g.useEffect)(c,l),s}function w(e){let t=(0,_.c)(10),{scale:n,color:r,baseTranslucency:i}=e,a=C(n),o;t[0]!==r[0]||t[1]!==r[1]||t[2]!==r[2]?(o=new s(r[0],r[1],r[2]),t[0]=r[0],t[1]=r[1],t[2]=r[2],t[3]=o):o=t[3];let c=o,l=i*1,u;t[4]!==c||t[5]!==l?(u=(0,x.jsx)(`meshBasicMaterial`,{color:c,transparent:!0,opacity:l,blending:2,side:2,depthWrite:!1,fog:!1}),t[4]=c,t[5]=l,t[6]=u):u=t[6];let d;return t[7]!==a||t[8]!==u?(d=(0,x.jsx)(`mesh`,{geometry:a,renderOrder:1,children:u}),t[7]=a,t[8]=u,t[9]=d):d=t[9],d}function T({scale:e,data:t}){let{animationEnabled:n}=a(),r=C(e),o=(0,g.useMemo)(()=>t.textures.map(e=>d(e)),[t.textures]),s=f(o,e=>{e.forEach(e=>S(e))}),c=(0,g.useMemo)(()=>b({textures:s,scale:e,umapping:t.umapping,vmapping:t.vmapping,color:t.color,baseTranslucency:t.baseTranslucency}),[s,e,t]);(0,g.useEffect)(()=>()=>c.dispose(),[c]);let l=(0,g.useRef)(0);return i((e,r)=>{if(!n){l.current=0,c.uniforms.currentFrame.value=0,c.uniforms.vScroll.value=0;return}l.current+=r,c.uniforms.currentFrame.value=Math.floor(l.current*t.framesPerSec)%t.numFrames,c.uniforms.vScroll.value=l.current*t.scrollSpeed}),(0,x.jsx)(`mesh`,{geometry:r,material:c,renderOrder:1})}function E(e){let t=(0,_.c)(20),{entity:n}=e,r=n.forceFieldData,i=r.dimensions,a=p(n.id);if(r.textures.map(D).length===0){let e;return t[0]!==r.baseTranslucency||t[1]!==r.color||t[2]!==i?(e=(0,x.jsx)(w,{scale:i,color:r.color,baseTranslucency:r.baseTranslucency}),t[0]=r.baseTranslucency,t[1]=r.color,t[2]=i,t[3]=e):e=t[3],e}let o;t[4]!==r.baseTranslucency||t[5]!==r.color||t[6]!==i?(o=(0,x.jsx)(w,{scale:i,color:r.color,baseTranslucency:r.baseTranslucency}),t[4]=r.baseTranslucency,t[5]=r.color,t[6]=i,t[7]=o):o=t[7];let s;t[8]!==r||t[9]!==i?(s=(0,x.jsx)(T,{scale:i,data:r}),t[8]=r,t[9]=i,t[10]=s):s=t[10];let c;t[11]!==o||t[12]!==s?(c=(0,x.jsx)(h,{name:`ForceField`,fallback:o,children:s}),t[11]=o,t[12]=s,t[13]=c):c=t[13];let l;t[14]!==a||t[15]!==i?(l=a&&i&&(0,x.jsx)(m,{size:i}),t[14]=a,t[15]=i,t[16]=l):l=t[16];let u;return t[17]!==c||t[18]!==l?(u=(0,x.jsxs)(x.Fragment,{children:[c,l]}),t[17]=c,t[18]=l,t[19]=u):u=t[19],u}function D(e){return d(e)}export{E as ForceFieldBare};