...
function TDMGame::onAIRespawn(%game, %client)
{
...
function TDMGame::onAIDamaged(%game, %clVictim, %clAttacker, %damageType, %implement)
{
...
function TDMGame::onAIKilledClient(%game, %clVictim, %clAttacker, %damageType, %implement)
{
	if (%clVictim.team != %clAttacker.team)
	   DefaultGame::onAIKilledClient(%game, %clVictim, %clAttacker, %damageType, %implement);
}

function TDMGame::onAIKilled(%game, %clVictim, %clAttacker, %damageType, %implement)
{
	DefaultGame::onAIKilled(%game, %clVictim, %clAttacker, %damageType, %implement);
}

function TDMGame::onAIFriendlyFire(%game, %clVictim, %clAttacker, %damageType, %implement)
{
...
function TDMGame::AIplayerCaptureFlipFlop(%game, %player, %flipFlop)
{
}
