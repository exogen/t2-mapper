...
$TaskDescription['NeedBombardier']		= '%1 needs bombardier.';

// AIObjectives for commands:
//---------------------------------------------------------------------------
// ZOD: This will be usefull for CnH, DnD, Conquest etc. flip flops.
$ObjectiveTable['CaptureObjective', type]             = "AIOTouchObject";
$ObjectiveTable['CaptureObjective', weightLevel1]     = 3850;
$ObjectiveTable['CaptureObjective', weightLevel2]     = 1500;
$ObjectiveTable['CaptureObjective', weightLevel3]     = 500;
$ObjectiveTable['CaptureObjective', weightLevel4]     = 100;
$ObjectiveTable['CaptureObjective', equipment]        = "";
$ObjectiveTable['CaptureObjective', desiredEquipment] = "Light EnergyPack";
$ObjectiveTable['CaptureObjective', buyEquipmentSet]  = "LightEnergyDefault";
$ObjectiveTable['CaptureObjective', offense]          = "true";
$ObjectiveTable['CaptureObjective', defense]          = "false";
$ObjectiveTable['CaptureObjective', assignTimeout]    = "5000";
$ObjectiveTable['CaptureObjective', maxAssigned]      = "2";
...
$ObjectiveTable['EscortPlayer', buyEquipmentSet]    = "";
$ObjectiveTable['EscortPlayer', offense]            = "true";
$ObjectiveTable['EscortPlayer', defense]            = "true";
$ObjectiveTable['EscortPlayer', assignTimeout]      = "4000";   // period allowed for humans to ack
...
$ObjectiveTable['RepairObject', weightLevel1]       = 2800;
$ObjectiveTable['RepairObject', weightLevel2]       = 1200;
$ObjectiveTable['RepairObject', weightLevel3]       = 600;
...
$ObjectiveTable['NeedRide', buyEquipmentSet]    = "LightEnergyDefault";
...
$ObjectiveTable['NeedPassenger', weightLevel2]       = 0;
$ObjectiveTable['NeedPassenger', weightLevel3]       = 0;
$ObjectiveTable['NeedPassenger', weightLevel4]       = 0;
...
$ObjectiveTable['NeedPassenger', chat]               = "ChatNeedHold";
$ObjectiveTable['NeedPassenger', offense]            = "true";
$ObjectiveTable['NeedPassenger', defense]            = "true";
$ObjectiveTable['NeedPassenger', assignTimeout]      = "3000";   // period allowed for humans to ack
$ObjectiveTable['NeedPassenger', maxAssigned]        = "1";      // not added if at least this many playrs have ack'd

$ObjectiveTable['NeedBombardier', type]               = "AIOEscortPlayer";
$ObjectiveTable['NeedBombardier', weightLevel1]       = 3500;
$ObjectiveTable['NeedBombardier', weightLevel2]       = 0;
$ObjectiveTable['NeedBombardier', weightLevel3]       = 0;
$ObjectiveTable['NeedBombardier', weightLevel4]       = 0;
$ObjectiveTable['NeedBombardier', equipment]          = "Light";
$ObjectiveTable['NeedBombardier', desiredEquipment]   = "";
$ObjectiveTable['NeedBombardier', buyEquipmentSet]    = "LightEnergyDefault";
$ObjectiveTable['NeedBombardier', chat]               = "ChatNeedHold";
$ObjectiveTable['NeedBombardier', offense]            = "true";
$ObjectiveTable['NeedBombardier', defense]            = "true";
$ObjectiveTable['NeedBombardier', assignTimeout]      = "3000";   // period allowed for humans to ack
$ObjectiveTable['NeedBombardier', maxAssigned]        = "1";      // not added if at least this many playrs have ack'd
...
function buildAIObjective(%client, %command)
{
   ...
   %objective = new AIObjective($ObjectiveTable[%tableIndex, type])
   {
      ...
      chat              = $ObjectiveTable[%tableIndex, chat];
...
$LookAtClientDistance = 50;//was 35 - Lagg...
...
function CreateVoiceServerTask(%client, %cmdCode)
{
   ...
   switch$ (%cmdCode)
   {
      ...
      //case 'ChatNeedDriver' or 'ChatNeedPilot' or 'ChatNeedRide' or 'ChatNeedHold': changed - Lagg...
      case 'ChatNeedDriver' or 'ChatNeedPilot' or 'ChatNeedRide':
         %client.setTargetId(%client.player.getTarget());
         %client.setTargetPos(%client.player.position);
         %cmdSent = true;
		...
		//vehicle passengers - these commands are for either air or ground - Lagg... - 5-17-2003
		case 'ChatNeedEscort' or 'ChatNeedPassengers' or 'ChatNeedSupport' or 'ChatNeedTailgunner':
         %client.setTargetId(%client.player.getTarget());
         %client.setTargetPos(%client.player.position);
         %cmdSent = true;
			//find out if the client is in a ground vehicle or not...
         //if (AIClientIsAlive(%targetClient) && %targetClient.isAIControlled()) - changed - Lagg...
         if (AIClientIsAlive(%targetClient))
         {
            //build and send the command to the target player
...
//------------------------------------------------------------------------------------------------------------------------
      ...
      case 'ChatNeedBombardier':
         ...
         {
            //build and send the command to the target player
            serverCmdBuildClientTask(%client, 'NeedBombardier', false);
            serverCmdSendTaskToClient(%client, %targetClient, false);
         }
         else
         {
            serverCmdBuildClientTask(%client, 'NeedBombardier', true);
            serverCmdSendTaskToTeam(%client);
         }
